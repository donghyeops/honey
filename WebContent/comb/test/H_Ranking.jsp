	...
	<div id="bulletin<%=i%>" class="w3-modal">
		<div class="w3-modal-content w3-card-8 w3-animate-zoom" style="max-width: 1000px">
			...
			<div class="w3-section">
				...
				<a href="HoneyControlB?from=ranking&action=list_remove&list_n=<%= event.getList_n() %>" >
					<button class="w3-btn w3-red w3-padding-large w3-round-large" style="width:50%"><b>삭제</b></button>	
				</a>
				<a href="HoneyControlB?from=ranking&action=list_update_form&list_n=<%= event.getList_n() %>" >
...
<div style="margin: 1950px 0px 0px 0px; width:1500px; height: 200px"></div>
