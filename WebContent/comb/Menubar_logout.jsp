...
  <li class="w3-hide-small w3-hide-medium" style="padding:12px 0px 12px 0px"><button type="submit" class="w3-btn w3-amber w3-padding-16" style="height:60px">Go</button>  </li>
  <li class="w3-hide-small w3-right w3-medium" style="width:150px"><a href="#" class="w3-padding-32" value="로그인" onclick="document.getElementById('LogIn').style.display='block'"><b>로그인</b></a></li>
...
  		<li class="w3-right"><button type="submit" class="w3-btn w3-amber">Go</button></li>
 ...
 <div id="LogIn" class="w3-modal">
   <div class="w3-modal-content w3-card-8 w3-animate-zoom"  style="width:80%; max-width:800px; padding-top:0%; padding-bottom:0%">
  ...
  <%--
    ...
    <form class="w3-container" name="join" method="post" action="/honey/HoneyControl">
      <div class="w3-section">
        ...
        <input type="button" class="w3-btn-block w3-amber w3-section w3-padding" onclick="javascript:checkJoinForm()" value="회원가입">
              </div>
    </form>
